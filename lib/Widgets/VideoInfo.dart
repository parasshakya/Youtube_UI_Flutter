  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(video.title, style: Theme.of(context).textTheme.bodyText1!.copyWith(fontSize: 15.0),),
...
class AuthorInfo extends StatelessWidget {
  ...
  const AuthorInfo({Key? key, required this.user}) : super(key: key);
       ...
       const SizedBox(width:8.0),
        Expanded(
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Flexible(child: Text(user.username, style: Theme.of(context).textTheme.bodyText1!.copyWith(fontSize: 15),
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
              )),
              Flexible(
                child: Text( user.subscribers,
                  overflow: TextOverflow.ellipsis,
        ...
        child: Text('SUBSCRIBE', style: Theme.of(context).textTheme.bodyText1!.copyWith(color: Colors.red),),
        )
      ],
    );
  }
